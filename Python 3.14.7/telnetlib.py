...
# Note: this file is CPython's stdlib telnetlib.py (last shipped in 3.12),
# vendored locally because the module was removed from the standard library
# in Python 3.13. The original module-level warnings._deprecated() call has
# been removed here since it unconditionally raises RuntimeError once past
# its stated removal version (3.13) -- which is meaningless for a vendored
# copy that's intentionally still in use.
